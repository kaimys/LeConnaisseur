...
function hbbtvlib_init_broadcast (parentId, objId, dummyPic) {
	try {
		...
		int_bc_container.innerHTML = '<object id="' + objId + '" type="video/broadcast" width="1280" height="720" style="visibility: visible; position:absolute; top:0px; left:0px; width:1280px; height:720px;"> </object>';
